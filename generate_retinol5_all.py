...
OUT_DIR = Path("/Users/lunahansen/Desktop/Claude ads/output/retinol_5")
...
for r in REVIEWS:
    ...
    for size in range(TEXT_SIZE + 8, 20, -1):
    ...
    # Vertically center text in grey area (equal space above and below)
