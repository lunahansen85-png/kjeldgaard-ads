...
BASE    = Path("/Users/lunahansen/Desktop/Claude ads/morten_base_6.jpg")
OUT_DIR = Path("/Users/lunahansen/Desktop/Claude ads/output/morten_6")
...
LINE_GAP   = 0
STROKE     = 0
Y_BOTTOM   = 1095   # bottom edge of the text block
Y_TOP_MAX  = 910     # text block won't be allowed to start higher than this
