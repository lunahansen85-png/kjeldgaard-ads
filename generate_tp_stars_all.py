...
BASE    = Path("/Users/lunahansen/Desktop/Claude ads/template_base_tp_stars.jpg")
OUT_DIR = Path("/Users/lunahansen/Desktop/Claude ads/output/tp_stars")
...
]  # kept for reference only — script now reads from reviews.csv
