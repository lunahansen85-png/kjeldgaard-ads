...
BASE    = Path("/Users/lunahansen/Desktop/Claude ads/template_base_2_new2.jpg")
...
REVIEWS = [
    ...
    {"quote": "Før jeg begyndte at bruge cremen, var min hud grå og meget tør. Nu er min hud bare silkeblød og har fået sin glød tilbage. Samtidig har den udglattet de små fine linjer og rynker.", "name": "- Marianne", "out": "p2_marianne_1.jpg"},
    # PAGE 3
    ...
    {"quote": "Jeg droppede natcremen og dagcremen - nu bruger jeg kun et produkt. Kjeldgaards Defense Serum har mindsket mine kragetæer ved øjnene og rynkerne rundt om munden.", "name": "- Karina", "out": "p3_karina_2.jpg"},
    ...
    {"quote": "Jeg er meget glad for Kjeldgaards Serum og ser meget tydelige resultater. Jeg er 63 år, og med dette serum opstrammes huden tydeligt, bliver mere klar og levende.", "name": "- Annette Asmus", "out": "p7_annette_1.jpg"},
