...
BASE    = Path("/Users/lunahansen/Desktop/Claude ads/morten_base_2.jpg")
OUT_DIR = Path("/Users/lunahansen/Desktop/Claude ads/output/morten_2")
...
LINE_GAP   = 0
STROKE     = 0
Y_BOTTOM   = 1290   # bottom edge of the text block
Y_TOP_MAX  = 1070    # text block won't be allowed to start higher than this
...
for r in REVIEWS:
    ...
    for line, line_h in zip(lines, line_heights):
        ...
        draw.rectangle([box_left, box_top, box_right, box_bot], fill=BLACK)
