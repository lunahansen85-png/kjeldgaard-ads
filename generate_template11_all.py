...
OUT_DIR  = Path("/Users/lunahansen/Desktop/Claude ads/output/template11")
...
REVIEWS = [
    ...
    {"headline": "KRAGETÆR VED\nØJNENE MINIMERET",     "quote": "Jeg droppede natcremen og dagcremen - nu bruger jeg kun ét produkt. Kjeldgaards Defense Serum har mindsket mine kragetæer ved øjnene og rynkerne rundt omkring munden.", "name": "- Karina", "out": "p3_karina_2.jpg"},
    ...
    {"headline": "ENDELIG EN SERUM\nDER VIRKER",       "quote": "Endelig lykkedes det mig at finde en serum som virkelig virker - er bare blevet mega afhængig af den, så kun en varm anbefaling herfra", "name": "- Pia Anne Marie Hansen", "out": "p4_pia_1.jpg"},
    ...
    {"headline": "FORSKEL ALLEREDE\nEFTER 1 UGE",     "quote": "Uundværlig! Allerede efter 1 uge var min hud og glød helt anderledes end den plejer, og efter 1 måneds brug har den synligt minimeret rynker og pigmenter.", "name": "- Louise Jeppesen", "out": "p6_louise_1.jpg"},
    ...
    {"headline": "TYDELIG FORSKEL\nI ANSIGTET",        "quote": "Har været meget tilfreds med Kjeldgaard Barrier Defense. Kan tydeligt mærke og se forskel på min hud i ansigtet.", "name": "- Jannie Lange Pedersen", "out": "p7_jannie_lp_1.jpg"},
    ...
    {"headline": "HUDEN FULDSTÆNDIG\nSILKEBLØD",      "quote": "Giver huden et fantastisk løft og masser af glød. I mit lange liv har jeg prøvet alverdens cremer, men dette produkt slår simpelthen alt. Min hud føles fuldstændig silkeblød, og man kan på ingen måde se, at jeg snart er 60 år.", "name": "- Anita Malmstedt", "out": "p8_anita_1.jpg"},
    {"headline": "MAN KAN IKKE SE\nJEG ER 60 ÅR",    "quote": "Man kan på ingen måde se, at jeg snart er 60 år. Jeg har prøvet alverdens cremer, men dette slår simpelthen alt!", "name": "- Anita Malmstedt", "out": "p8_anita_2.jpg"},
    # PAGE 9
