...
BASE    = Path("/Users/lunahansen/Desktop/Claude ads/morten_base_1.jpg")
OUT_DIR = Path("/Users/lunahansen/Desktop/Claude ads/output/morten_1")
...
LINE_GAP   = 0
STROKE     = 0
Y_BOTTOM   = 1310   # bottom edge of the text block
Y_TOP_MAX  = 930     # text block won't be allowed to start higher than this
