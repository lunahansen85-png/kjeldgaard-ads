...
BASE    = Path("/Users/lunahansen/Desktop/Claude ads/morten_base_8.jpg")
OUT_DIR = Path("/Users/lunahansen/Desktop/Claude ads/output/morten_8")
...
STROKE     = 0
RADIUS     = 22
Y_BOTTOM   = 1390   # bottom edge of the text block
Y_TOP_MAX  = 1150    # text block won't be allowed to start higher than this
